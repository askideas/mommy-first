...
const MomsReviewsSlider = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The cooling pads + witch hazel were a lifesaver. I used the First Week System as soon as I got home and it was so much less scary.",
      author: {
        name: "Maria",
        tag: "vaginal birth",
        avatar: m2,
    ...
    },
    {
      ...
      rating: 5,
      review:
        "No one told me how much I'd bleed or how sore I'd be. The 2 Week Set meant I didn't have to send my partner out at midnight for more pads.",
      author: {
        name: "Jessica",
        tag: "first-time mom",
        avatar: m3,
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The 2 Week Set meant I didn't have to send my partner out at midnight for more pads. Everything was already waiting for me at home.",
      author: {
        name: "Jessica",
        tag: "first-time mom",
        avatar: m4,
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The cooling pads + witch hazel were a lifesaver. I used the First Week System as soon as I got home and going to the bathroom felt so much less scary.",
      author: {
        name: "Maria",
        tag: "vaginal birth",
        avatar: m5,
      ...
      <div className="container">
        <div className="momsreview-section-heading" ref={headingRef}>
          <div className="head-ing">
            ...
            <h2>
              Postpartum is hard enough. The right support makes a bigger
              difference than anyone tells you.
            </h2>
          </div>
                  ...
                  <div className="review-author">
                    ...
                    <div className="author-info">
                      <p className="author-name">
                        {review.author.name},{" "}
                        <span className="author-tag">{review.author.tag}</span>
                      </p>
                    </div>
                  </div>
                </div>
